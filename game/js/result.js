...
export function show(type,result,dataset){
    ...
    if(score==maxScore){
        ...
        document.getElementById('resultTitle').innerText = "Parfait !"
    }
        ...
        document.getElementById('resultTitle').innerText = "Excellent !"
    }
        ...
        document.getElementById('resultTitle').innerText = "Très bien !"
    }
        ...
        document.getElementById('resultTitle').innerText = "Pas mal !"
    }
        ...
        document.getElementById('resultTitle').innerText = "Presque"
    }
        ...
        document.getElementById('resultTitle').innerText = "Dommage"
    }
    else{

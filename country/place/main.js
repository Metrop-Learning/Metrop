...
function showResult() {
  ...
  else if(failed.length <= (listCountry.length * 0.1) && (listCountry.length * 3) * 0.9 < ((good.length * 3) + (miss.length * 1))){
  ...
  else if((listCountry.length * 3) * 0.8 < ((good.length * 3) + (miss.length * 1))){
  ...
  else if((listCountry.length * 3) * 0.65 < ((good.length * 3) + (miss.length * 1))){
  ...
  else if((listCountry.length * 3) * 0.5 < ((good.length * 3) + (miss.length * 1))){
  ...
  else if((listCountry.length * 3) * 0.3 < ((good.length * 3) + (miss.length * 1))){

...
function refreshStylesResult() {
  ...
  const defaultStyle = { color: grey, weight: 1, fillColor: lightGrey, fillOpacity: 0.3, opacity: 1 };
  const missStyle = { color: missColor, weight: 1, fillColor: missLightColor, fillOpacity: 0.6, opacity: 1 };
  const nofailStyle = { color: green, weight: 1, fillColor: lightGreen, fillOpacity: 0.6, opacity: 1 };
  const failStyle = { color: failColor, weight: 1, fillColor: failLightColor, fillOpacity: 0.6, opacity: 1 };

...
function refreshStylesResult() {
  ...
  const missStyle = { color: missColor, weight: 1, fillColor: missLightColor, fillOpacity: 0.6 };
  const nofailStyle = { color: green, weight: 1, fillColor: lightGreen, fillOpacity: 0.6 };
  const failStyle = { color: failColor, weight: 1, fillColor: failLightColor, fillOpacity: 0.6 };
